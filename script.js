...
console.log('Suma numerelor 2 si 3 este egala cu', add(2, 3));
console.log('Diferenta numerelor 3 si 2 este egala cu', subt(3, 2));
console.log('Impartirea numerelor 20 si 10 este egala cu', divide(20, 10));
console.log('Produsul numerelor 5 si 5 este egal cu', multiply(5, 5));
console.log('Restul impartirii numerelor 20 si 3 este egal cu', mod(20, 3));
console.log('2 la puterea 5 este egal cu', exponent(2, 5));
